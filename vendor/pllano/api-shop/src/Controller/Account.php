...
class Account
{
    ...
    public function sign_in(Request $request, Response $response, array $args)
    {
        $config = $this->config;
    ...
    public function sign_up(Request $request, Response $response, array $args)
    {
        $config = $this->config;
    ...
    public function check_in(Request $request, Response $response, array $args)
    {
        $config = $this->config;
