...
$app->get('/_put/{table:[\w]+}[/{id:[0-9]+}]', function (Request $request, Response $response, array $args) {
...
$app->get('/_patch/{table:[\w]+}[/{id:[0-9]+}]', function (Request $request, Response $response, array $args) {
