...
- [jsonDB](https://github.com/pllano/json-db) позволяет работать напрямую с jsonDB, транзитом через клас [JsonDb](https://github.com/pllano/api-shop/blob/master/app/classes/Database/JsonDb.php)
