...
Написан на PHP 7. Распространяется по лицензии [MIT](https://opensource.org/licenses/MIT).
...
- Конфигурация Демо сайта: FastCGI (Nginx + PHP-FPM) + PHP 7.0.27 + Кеш Predis + Кеш Twig
